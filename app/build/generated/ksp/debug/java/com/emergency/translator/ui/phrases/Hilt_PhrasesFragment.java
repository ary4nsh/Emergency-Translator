...
public abstract class Hilt_PhrasesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhrasesFragment() {
    super();
  }

  Hilt_PhrasesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhrasesFragment_GeneratedInjector) this.generatedComponent()).injectPhrasesFragment(UnsafeCasts.<PhrasesFragment>unsafeCast(this));
    }
  }
